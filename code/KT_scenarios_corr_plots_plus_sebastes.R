...
# Simulation data
# --note that this function compiles the simulation output generated by
#   Hurlbert & Stegen and provided with the repository in the 
#   analysis_output subdirectory.
# --if you wish to generate a plot based on simulation output you run
#   yourself, note that the filename in this function should be changed
#   to paste('analysis_output/SENC_Stats_sim', sim, '_all_subclades.csv', sep = '')
#   as specified in analysis_workflow_Olympus.r
compile.stats = function(sims) {
  compiled = c()
  for (sim in sims) {
    temp = read.csv(paste('analysis_output/SENC_Stats_sim', sim, '.csv', sep = ''), header = T)
